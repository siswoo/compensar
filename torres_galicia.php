...
<main class="container">
	<div class="row">
		<div class="col-12 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">Apartamento Torres de Galicia</div>
	</div>
</main>
	...
	<div class="container" style="margin-top:3rem;">
		<div class="row">
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa2_1.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa2_2.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa2_4.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
		</div>
		<div class="row mt-3 card">
			<div class="row" style="padding: 1rem;">
				...
				<div class="col-4 text-center" style="margin-top: 1rem;">
					<p>Precio: $191.197.507</p>
				</div>
				<div class="col-4 text-center" style="margin-top: 1rem;">
					<p>Dirección: Calle 139 # 94 - 18</p>
				</div>
				...
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Fecha de inicio: 01/12/2021</div>
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Entrega estimada: 01/03/2025</div>
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Valor de Separación: $5.000.000</div>

				<div class="col-12 text-center" style="margin-top: 1rem; padding-top: 1rem; font-weight: bold;">Características</div>
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Area total: 64m²</div>
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Area techada: 64m²</div>
				<div class="col-4 text-center" style="margin-top: 1rem; padding-top: 1rem;">Habitaciones: 2</div>
		...
		<form id="formulario1" action="#" method="POST">
			<div class="row card">
				...
				<div class="col-12" style="padding-top:1rem; padding-bottom:1rem;">
					...
					<input type="text" name="viviendo_aplicada" id="viviendo_aplicada" class="form-control" value="Apartamento Torres de Galicia" readonly>
				</div>
