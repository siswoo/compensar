...
<main class="container">
	<div class="row">
		<div class="col-12 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">Apartamento Viena</div>
	</div>
</main>
	...
	<div class="container" style="margin-top:3rem;">
		<div class="row">
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa4_1.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa4_2.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
			<div class="col-4 text-center" style="font-weight: bold; font-size: 36px; color: black; margin-top: 1rem;">
				<img src="img/casa4_4.jpg" class="img-fluid" style="margin-top:1rem; width: 600px;">
			</div>
		</div>
		<div class="row mt-3 card">
			<div class="row" style="padding: 1rem;">
				...
				<div class="col-4 text-center" style="margin-top: 1rem;">
					<p>Precio: $423.200.000</p>
				</div>
				<div class="col-4 text-center" style="margin-top: 1rem;">
					<p>Dirección: Kennedy</p>
				</div>
		...
		<form id="formulario1" action="#" method="POST">
			<div class="row card">
				...
				<div class="col-12" style="padding-top:1rem; padding-bottom:1rem;">
					...
					<input type="text" name="viviendo_aplicada" id="viviendo_aplicada" class="form-control" value="Apartamento Viena" readonly>
				</div>
